...
Extract:
1. **Entities** — extract using ONLY these types: person, organization, project, concept, tool, content
   Map events/places/decisions to the closest allowed type (e.g. a conference → concept, a decision → concept)
